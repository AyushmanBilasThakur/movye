...
(function (factory) {
    ...
    var config = {
        ...
        execute: function (message, processedCommand) { return __awaiter(void 0, void 0, void 0, function () {
            var guild, member, mediaList, movieList_1, _a, type, name_1, data_1, flag_1, embed, mediaMessage, checkReactionFilter, err_1;
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        if (!member.hasPermission("ADMINISTRATOR")) {
                            return [2 /*return*/, message.channel.send("Only pepole with admin permission can add new movies, but you can search for new movies with the `search` command... For more details use the `help` command. Or you can add to your personal list with `add_to_personal_list` command in either dm or here!")];
                        }
                        _b.label = 1;
                    case 1:
                        _b.trys.push([1, 7, , 8]);
                        return [4 /*yield*/, MediaList_1.default.findOne({ id: guild.id })];
                    case 2:
                        mediaList = _b.sent();
                        if (mediaList == undefined) {
                            return [2 /*return*/, message.channel.send("You don't have this movie saved in the database")];
                        }
                        ...
                        if (!(searchTypes_1.default.includes(type))) {
                            return [2 /*return*/, message.channel.send("You searched for an invalid type - " + type)];
                        }
                        return [4 /*yield*/, omdbRequest_1.default(name_1, type)];
                    case 3:
                        data_1 = _b.sent();
                        if (data_1.Response == "False") {
                            return [2 /*return*/, message.channel.send("Sorry your " + type + " " + name_1 + " could not be found!")];
                        }
                        flag_1 = 0;
                        ...
                        if (flag_1 == 0)
                            return [2 /*return*/, message.channel.send("You don't have this movie in your watch list")];
                            ...
                            return __generator(this, function (_b) {
                                switch (_b.label) {
                                    ...
                                    case 1:
                                        ...
                                        return [4 /*yield*/, MediaList_1.default.findOneAndUpdate({ id: guild.id }, { list: movieList_1 })];
                                    case 2:
                                        _b.sent();
                                        message.channel.send("Movie removed successfully from the list");
                                        return [3 /*break*/, 5];
                                    case 3:
                                        message.channel.send("Okay won't delete this movie from the watch list");
                                        return [3 /*break*/, 5];
                                    case 4:
                                        console.log("Default");
                                        _b.label = 5;
