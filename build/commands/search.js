...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../utils/searchTypes", "../utils/omdbRequest", "../utils/typeAndNameExtractor", "../utils/createMovieEmbed"], factory);
    }
    ...
    var config = {
        ...
        execute: function (message, processedCommand) { return __awaiter(void 0, void 0, void 0, function () {
            var _a, type, name_1, data, embed, err_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        embed = createMovieEmbed_1.default(data);
